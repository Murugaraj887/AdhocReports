<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinpulseActivities.aspx.cs" Inherits="AdhocReports.FinpulseActivities" %>
...
<body>
    <form id="form1" runat="server">
         ...
         <div class="topnav">
  <a  href="home.aspx">Adhoc Reports</a>
  <a href="basedatareports.aspx">Base Reports</a>
  <a class="active" href="finpulseactivities.aspx">Finpulse Activities</a>
 </div>


         <div style="padding-left:5px">
            <asp:GridView ID="gvAdhoc" runat="server" CssClass="table" AutoGenerateColumns="false">
                <Columns>


                    <asp:TemplateField HeaderText ="Finpulse Activities" HeaderStyle-ForeColor="White" HeaderStyle-Font-Size="25px" HeaderStyle-BackColor="Black"  >
                        <ItemTemplate>
