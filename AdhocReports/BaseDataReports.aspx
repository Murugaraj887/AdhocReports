<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaseDataReports.aspx.cs" Inherits="AdhocReports.BaseDataReports" %>
...
<body>
  ...
  <a class="active"  href="basedatareports.aspx">Base Reports</a>
        ...
        <div style="padding-left:5px">
            <asp:GridView ID="gvAdhoc" runat="server" CssClass="table" AutoGenerateColumns="false" OnRowDataBound="gvAdhoc_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText =" Base Data Generation" HeaderStyle-ForeColor="White" HeaderStyle-Font-Size="25px" HeaderStyle-BackColor="Black"  >
                        <ItemTemplate>
